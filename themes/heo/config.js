const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '这是我做的第一个网站开发项目', url: 'http://courseconnect.cn/' },
    { title: '访问旧博客', url: 'http://cajzella.github.io/' },
    { title: 'NotionNext博客系统', url: 'https://github.com/tangly1024/NotionNext'}
  ],
  ...
  HERO_CATEGORY_2: { title: '面向对象', url: '/tag/面向对象' },
  HERO_CATEGORY_3: { title: '操作系统', url: '/tag/操作系统' },
